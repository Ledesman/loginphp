                  ...
                  <form method="POST" id="form_compra" name="form_compra"  action="<?php echo base_url(); ?>/compras/guarda" autocompletar="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div clas="col-12 col-sm-4">
                          <label><br>&nbsp;</label>
                          <button id="agregar_producto" name="agregar_producto" type="button" class="btn btn-primary form-control" onclick="agregarProducto(id_producto.value,cantidad.value, '')">Agregar producto</button>
                        </div>
